...
REGISTRY: list[SettingDef] = [
    ...
    _d("snmp_inventory.sweep_edp", "bool", True, "Sweep: EDP neighbors", attr="sweep_edp"),
    _d("snmp_inventory.edp_interval_s", "int", 1800, "EDP interval (s)",
       attr="edp_interval_s", min=60),
