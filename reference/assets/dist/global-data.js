...
const GLOBAL_SITES = [{
  ...
  id: "MTV",
  name: "Martin Luther King Jr Elem",
  type: "elem",
  hosts: 54,
  problems: 0,
  sev: "ok",
...
const GLOBAL_DOMAINS = [{
  ...
  kpis: [{
    label: "APs online",
    value: "1,162 / 1,184",
    note: "22 APs with problems"
  }, {
    label: "Connected clients",
    value: "4,328",
    note: "ax 3,981 · ac 295"
  }, {
    label: "RF health",
    value: "94",
    unit: "/100",
    note: "target ≥ 90 · 2.4 GHz dragging"
  }],
  ...
  sparkColor: "var(--ext)",
  sparkLabel: "Connected clients · 24h",
  ...
  kpis: [{
    label: "Servers up",
    value: "16 / 17",
    note: "1 down (db replica)"
  }, {
    label: "CPU avg",
    value: "42",
    unit: "%",
    note: "peak 71% (zbx-db-01)"
  }, {
    label: "Disk pressure",
    value: "3",
    note: "vols >80% used"
...
const GLOBAL_TRIGGERS = [{
  ...
  domain: "switches",
  source: "zbx",
  trigger: "Stack member offline (slot 2)",
  ack: false
}, {
  sev: "disaster",
  age: "00:06:42",
  ...
  domain: "switches",
  source: "zbx",
  trigger: "Uplink to TCS-CO down (Te1/49)",
  ack: false
}, {
  sev: "high",
  age: "00:11:08",
  host: "infra-zbx-db-01",
  site: "TDC",
  domain: "servers",
  source: "zbx",
  trigger: "Disk /var/lib > 88% (delta +12%/24h)",
  ack: true
}, {
  sev: "high",
  age: "00:14:33",
  ...
  domain: "wireless",
  source: "zbx",
  trigger: "AP lost LAN connectivity",
  ack: false
}, {
  sev: "high",
  age: "00:18:51",
  ...
  domain: "nvr",
  source: "zbx",
  trigger: "Recording lag > 4s on 11 cameras",
  ack: false
}, {
  sev: "high",
  age: "00:22:14",
  ...
  domain: "switches",
  source: "zbx",
  trigger: "PSU2 failed — running on PSU1 only",
  ack: true
}, {
  sev: "high",
  age: "00:31:02",
  ...
  domain: "servers",
  source: "pf",
  trigger: "PacketFence radius queue > 200",
  ack: false
}, {
  sev: "warning",
  age: "00:42:18",
  ...
  domain: "wireless",
  source: "zbx",
  trigger: "5 GHz utilization > 75% (sustained)",
  ack: false
}, {
  sev: "warning",
  age: "00:48:09",
  ...
  domain: "wireless",
  source: "zbx",
  trigger: "Client roam failure rate > 4%",
  ack: false
}, {
  sev: "warning",
  age: "01:03:55",
  ...
  domain: "switches",
  source: "zbx",
  trigger: "PoE budget > 92% (Gi1/0/24)",
  ack: false
}, {
  sev: "warning",
  age: "01:14:21",
  host: "infra-pf-mariadb",
  site: "TDC",
  domain: "servers",
  source: "pf",
  ...
  domain: "nvr",
  source: "zbx",
  trigger: "Camera reboot loop (3 in 10m)",
  ack: false
}, {
  sev: "info",
  age: "01:38:02",
  ...
  domain: "wireless",
  source: "ext",
  trigger: "Firmware out of date (32.7.0.5)",
  ack: false
}, {
  sev: "info",
  age: "02:04:31",
  ...
  domain: "switches",
  source: "zbx",
  trigger: "SFP receive power low (-22.4 dBm)",
  ack: true
}];
...
const GLOBAL_EVENTS = [{
  ...
  host: "BHS-23-Cafe",
  msg: "Trigger:",
  obj: "AP lost LAN connectivity",
  sev: "high"
}, {
  ts: "10:13:48",
  source: "pf",
  host: "F4:5C:89:0B:32:71",
  msg: "Quarantined:",
  obj: "policy violation (rogue DHCP)",
  sev: "warning"
}, {
  ts: "10:11:02",
  source: "zbx",
  ...
  host: "PHS-AP-Lib-03",
  msg: "Drift:",
  obj: "firmware 32.7.0.5 → 32.7.0.7 available",
  sev: "info"
}, {
  ts: "10:06:42",
  source: "zbx",
  host: "CRS-DIST-01",
  msg: "Trigger:",
  obj: "Uplink to TCS-CO down (Te1/49)",
  sev: "disaster"
}, {
  ts: "10:04:11",
  source: "zbx",
  host: "CRS-CORE-01",
  msg: "Trigger:",
  obj: "Stack member offline (slot 2)",
  sev: "disaster"
}, {
  ts: "10:03:08",
  source: "pf",
  host: "k.davis@tcs",
  msg: "Auth:",
  obj: "EAP-TLS success on BHS-56-Hallway",
  sev: "ok"
}, {
  ts: "10:01:54",
  source: "zbx",
  host: "BHS-CAM-N-014",
  msg: "Trigger:",
  obj: "Camera reboot loop (3 in 10m)",
  sev: "warning"
}, {
  ts: "09:58:33",
  source: "zbx",
  host: "NRH-ACC-04",
  msg: "Resolved:",
  obj: "Client count anomaly",
  sev: "ok"
}, {
  ts: "09:55:21",
  source: "pf",
  host: "guest-staff-iPad",
  msg: "Onboard:",
  obj: "BYOD provisioning OK (VLAN 50)",
  sev: "ok"
}, {
  ts: "09:52:09",
  source: "zbx",
  host: "nvr-rec-04",
  msg: "Trigger:",
  obj: "Recording lag > 4s on 11 cameras",
  sev: "high"
}];

// 24h timeline of new problems opened — used for the trend strip at the top
const PROBLEM_TIMELINE = [3, 4, 2, 3, 5, 4, 6, 8, 11, 14, 18, 21, 19, 17, 16, 15, 17, 19, 22, 24, 28, 34, 41, 47];
