...
const FG_TOTALS = {
  ...
  threats: {
    ips_blocks_24h: 9_847,
    av_blocks_24h: 142,
    web_blocks_24h: 38_412,
    app_blocks_24h: 4_281
  },
  vpn: {
    ipsec_up: 14,
    ipsec_total: 16,
...
const FG_SESSIONS_24H = [64, 58, 52, 48, 46, 48, 62, 98, 128, 148, 162, 171, 179, 184, 182, 180, 184, 188, 182, 168, 148, 124, 102, 84];
const FG_NEW_SESSIONS_24H = [1_120, 940, 780, 620, 560, 640, 1_180, 2_640, 3_810, 4_120, 4_310, 4_460, 4_580, 4_490, 4_410, 4_320, 4_510, 4_640, 4_380, 3_910, 3_080, 2_310, 1_780, 1_410];
...
const FG_TOP_THREATS = [{
  sig: "ET POLICY · Cleartext credentials in HTTP",
  cat: "Policy",
  count: 1284,
  src: "10.20.41.118",
  dstCC: "US",
  ...
  sig: "ET EXPLOIT · Log4Shell JNDI lookup attempt",
  cat: "Exploit",
  count: 812,
  src: "various WAN",
  dstCC: "US",
  ...
  sig: "ET MALWARE · Mirai variant traffic",
  cat: "Malware",
  count: 248,
  src: "10.50.12.4",
  dstCC: "—",
  ...
  sig: "ET HUNTING · SSL self-signed cert · suspicious",
  cat: "Hunting",
  count: 184,
  src: "various WAN",
  dstCC: "CN",
  ...
  sig: "Botnet C&C · feed bf:c2.fortiguard",
  cat: "Bot C&C",
  count: 18,
  src: "10.30.22.41",
  dstCC: "RO",
...
const FG_TOP_POLICIES = [{
  ...
  id: 17,
  name: "Student VLAN → WAN · webfilter",
  from: "vlan20 · stu",
  to: "wan1",
  service: "ANY",
  action: "allow",
  ...
  id: 31,
  name: "Guest captive → WAN · throttled",
  from: "vlan60 · gst",
  to: "wan2",
  service: "443/80/53",
  action: "allow",
  ...
  id: 101,
  name: "Geo-block · CN/RU/KP inbound",
  from: "wan1/wan2",
  to: "any",
  service: "ANY",
  action: "deny",
  ...
  id: 144,
  name: "Block · botnet feed (FortiGuard)",
  from: "any",
  to: "any",
  service: "ANY",
  action: "deny",
...
const FG_EVENTS = [{
  ...
  obj: "TCS-CO ⇄ Central ES (00:04:11 ago)"
}, {
  ts: "16:41:02",
  source: "zbx",
  host: "fw-tcs-co-01",
  sev: "info",
  msg: "Active sessions ",
  obj: "184,213 (+2.1k in 60s)"
}, {
  ts: "16:38:44",
  source: "zbx",
  host: "fw-tcs-co-01",
  sev: "high",
  msg: "IPS · Log4Shell JNDI lookup attempt blocked × 12 · ",
  obj: "src: various WAN"
}, {
  ts: "16:36:11",
  source: "pf",
  host: "fw-tcs-co-01",
  sev: "info",
  msg: "SSL-VPN authenticated · ",
  obj: "user=jharris (faculty) via MFA"
}, {
  ts: "16:34:08",
  source: "zbx",
  host: "fw-tcs-co-01",
  sev: "disaster",
  msg: "Botnet C&C destination blocked · ",
  obj: "10.30.22.41 → c2.host.ro (policy 144)"
}, {
  ts: "16:31:52",
  source: "zbx",
  host: "fw-tcs-co-01",
  sev: "warning",
  msg: "CPU sustained > 70% (15m peak) · ",
  obj: "now 38% / peak 71%"
}, {
  ts: "16:30:04",
  source: "zbx",
  host: "fw-tcs-co-01",
  sev: "info",
  msg: "HA heartbeat sync OK · ",
  obj: "checksum match · 4128 objects"
}, {
  ts: "16:28:33",
  source: "pf",
  host: "fw-tcs-co-01",
  sev: "info",
  msg: "SSL-VPN session closed · ",
  obj: "user=asmith · no MFA · flagged"
}, {
  ts: "16:26:18",
  source: "zbx",
  host: "fw-tcs-co-02",
  sev: "ok",
  msg: "Secondary node healthy · ",
  obj: "sessions=167,982 / cpu=21%"
}, {
  ts: "16:24:01",
  source: "zbx",
  host: "fw-tcs-co-01",
  sev: "warning",
  msg: "SD-WAN · wan3 LTE loss 0.8% / latency 48.8 ms · ",
  obj: "weight reduced to 5"
}];
